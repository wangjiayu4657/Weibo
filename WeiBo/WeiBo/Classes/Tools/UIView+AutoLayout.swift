...
public enum XMG_AlignType {
    ...
    fileprivate func layoutAttributes(isInner: Bool, isVertical: Bool) -> XMG_LayoutAttributes {
        let attributes = XMG_LayoutAttributes()
        
        switch self {
            case .TopLeft:
                attributes.horizontals(from: NSLayoutAttribute.left, to: NSLayoutAttribute.left).verticals(from: NSLayoutAttribute.top, to: NSLayoutAttribute.top)
...
extension UIView {
    ...
    :returns: 约束数组
    */
    @discardableResult public func xmg_Fill(referView: UIView, insets: UIEdgeInsets = UIEdgeInsets.zero) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    @discardableResult public func xmg_AlignInner(type: XMG_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPoint.zero) -> [NSLayoutConstraint]  {
    ...
    :param: size      视图大小，如果是 nil 则不设置大小
    :param: offset    偏移量，默认是 CGPoint(x: 0, y: 0)
    :@discardableResult: 代表可以不使用返回值
     
    :returns: 约束数组
    */
    @discardableResult public func xmg_AlignVertical(type: XMG_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPoint.zero) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    @discardableResult public func xmg_AlignHorizontal(type: XMG_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPoint.zero) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    @discardableResult public func xmg_HorizontalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
